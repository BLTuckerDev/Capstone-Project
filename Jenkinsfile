node{
    ...
    sh "gcloud beta test android run --project ${env.GCLOUD_NANODEGREE_CAPSTONE_PROJECT_ID} --app app/build/outputs/apk/app-debug.apk --test app/build/outputs/apk/app-debug-androidTest.apk --device-ids Nexus5,Nexus6,Nexus9 --os-version-ids 21,22,23 --locales en --orientations portrait,landscape"
